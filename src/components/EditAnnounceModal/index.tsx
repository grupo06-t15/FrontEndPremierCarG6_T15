...
export const EditAnnounceModal = () => {
  ...
  return (
    <ModalContainer>
      <ModalHeader>
        <ModalTitle>Editar anúncio</ModalTitle>
        <CloseModalBtn onClick={(e) => setModalType("")}>X</CloseModalBtn>
      </ModalHeader>
      <ModalForm>
        <ModalFormTitle htmlFor="title">Informações do veículo</ModalFormTitle>
        <ModalFormImputContainer>
        ...
        <ModalFormImputContainer className="sublcass">
          ...
          <ModalFormSubclass>
            <ModalFormSubclassTitle htmlFor="price">Preço</ModalFormSubclassTitle>
            <ModalFormSubclassInput
              id="price"
              type="text"
        ...
        <StyledTypeButtonsAccount>
          <label
            className={`radio-label ${
              selectedAccountType === "sim" ? "selected" : ""
            }`}
          >
            <input
              type="radio"
              value="sim"
              checked={selectedAccountType === "sim"}
              onChange={() => setSelectedAccountType("sim")}
              defaultChecked
            />
            Sim
          </label>
          <label
            className={`radio-label ${
              selectedAccountType === "não" ? "selected" : ""
            }`}
          >
            <input
              type="radio"
              value="não"
              checked={selectedAccountType === "não"}
              onChange={() => setSelectedAccountType("não")}
            />
            Não
          </label>
        </StyledTypeButtonsAccount>
