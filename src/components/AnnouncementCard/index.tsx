...
import { Active, Announcement, CarData, CarImage, Inactive, Sale, UserData } from "./style";
            ...
            {models.map((car) => (
                <Announcement key={uuidv4()}>
                    ...
                    <StyledText tag="h1" type="Heading-7-600" color="grey1">
                        {car.brand.charAt(0).toUpperCase() + car.brand.substr(1) + " - " + car.name.split(" ")[0].charAt(0).toUpperCase() + car.name.split(" ")[0].substr(1)}
                    </StyledText>
