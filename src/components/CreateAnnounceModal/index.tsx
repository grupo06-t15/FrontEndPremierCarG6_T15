...
export const CreateAnnouceModal = () => {
    ...
    return (
        <ModalContainer>
            ...
            <ModalForm>
                <ModalFormTitle htmlFor="title">
                    Infomações do veículo
                </ModalFormTitle>
                <ModalFormImputContainer>
                    <ModalFormInputTitle htmlFor="brand">
                        Marca
                    </ModalFormInputTitle>
                    <ModalFormSelect
                        name="brand"
                ...
                <ModalFormImputContainer>
                    <ModalFormInputTitle htmlFor="model">
                        Modelo
                    </ModalFormInputTitle>
                    <ModalFormSelect
                        name="model"
                        ...
                        onChange={(e) =>
                            setCurrentCar(
                                modelList.find(
                                    (car: TCar) => car.name === e.target.value
                                ) || ({} as TCar)
                            )
                        }
                    >
                ...
                <ModalFormImputContainer className="sublcass">
                    <ModalFormSubclass>
                        <ModalFormSubclassTitle htmlFor="year">
                            Ano
                        </ModalFormSubclassTitle>
                        <ModalFormSubclassInput
                            id="year"
                ...
                <ModalFormImputContainer className="sublcass">
                    ...
                    <ModalFormSubclass>
                        <ModalFormSubclassTitle htmlFor="color">
                            Cor
                        </ModalFormSubclassTitle>
                        <ModalFormSubclassInput
                            id="color"
